...
const translations = {
  en: {
    ...
    // Course: Drone 360°
    drone360Title: "Drone 360°: From Basics to Projects",
    drone360Desc: "End-to-end intro to drones — components, flight basics, and a hands-on project.",
    drone360About: "A practical introduction to drones aimed at beginners. We start with the components and physics of flight, move through your first manual flight, and end with a small autonomous project. No prior experience required.",
    drone360Mod1Title: "Module 1 — Drone Anatomy & Flight Physics",
    drone360Mod1Desc: "What's inside a drone, how lift and stabilization work, and how to read a build.",
    drone360Mod1Q1: "How clear was this module's explanation?",
    drone360Mod1Q2: "How well did the slides reinforce the video?",
    drone360Mod1Q3: "How confident do you feel about drone components now?",
    drone360Mod2Title: "Module 2 — Your First Flight",
    drone360Mod2Desc: "Pre-flight checklist, takeoff, control basics, and safe landing.",
    drone360Mod2Q1: "How clear were the pre-flight steps?",
    drone360Mod2Q2: "How comfortable do you feel about control inputs?",
    drone360Mod2Q3: "How likely are you to apply this in a real flight?",
    // Course registration
    ...
    universityPlaceholder: "e.g. University of Jeddah",
    majorField: "Major / Specialization",
    majorPlaceholder: "e.g. Computer Engineering",
    levelField: "Current level",
    levelPlaceholderStudent: "Undergraduate",
    levelPlaceholderGraduate: "Graduate",
    levelPlaceholderProfessional: "Professional",
    motivationField: "Why this course? (optional)",
    motivationPlaceholder: "What you hope to build or learn",
  ...
  ar: {
    ...
    // Course: Drone 360°
    drone360Title: "درون 360°: من الأساسيات إلى المشاريع",
    drone360Desc: "مقدمة شاملة للطائرات بدون طيار — المكونات، أساسيات الطيران، ومشروع تطبيقي.",
    drone360About: "مقدمة عملية للطائرات بدون طيار للمبتدئين. نبدأ من المكونات وفيزياء الطيران، نمر بأول طيران يدوي، وننتهي بمشروع صغير ذاتي القيادة. لا تحتاج خبرة سابقة.",
    drone360Mod1Title: "الوحدة 1 — تشريح الدرون وفيزياء الطيران",
    drone360Mod1Desc: "ما الذي بداخل الدرون، كيف يعمل الرفع والاستقرار، وكيف تقرأ الـ build.",
    drone360Mod1Q1: "ما مدى وضوح شرح هذه الوحدة؟",
    drone360Mod1Q2: "ما مدى دعم السلايدز للفيديو؟",
    drone360Mod1Q3: "ما مدى ثقتك في فهم مكونات الدرون الآن؟",
    drone360Mod2Title: "الوحدة 2 — أول طيران لك",
    drone360Mod2Desc: "قائمة الفحص قبل الطيران، الإقلاع، أساسيات التحكم، والهبوط الآمن.",
    drone360Mod2Q1: "ما مدى وضوح خطوات ما قبل الطيران؟",
    drone360Mod2Q2: "ما مدى راحتك مع مدخلات التحكم؟",
    drone360Mod2Q3: "ما مدى احتمالية تطبيقك لهذا في طيران فعلي؟",
    // Course registration
    registrationTitle: "سجّل لبدء الكورس",
    registrationDesc: "أقرأ كل تسجيل بنفسي — شاركني معلومة بسيطة عن خلفيتك حتى أستطيع تطوير المحتوى لمن يشبهك.",
    fullName: "الاسم الكامل",
    fullNamePlaceholder: "اسمك الكامل",
    universityField: "الجامعة / المؤسسة",
    universityPlaceholder: "مثلاً جامعة جدة",
    majorField: "التخصص",
    majorPlaceholder: "مثلاً هندسة الحاسب",
    levelField: "المستوى الحالي",
    levelPlaceholderStudent: "طالب جامعي",
    levelPlaceholderGraduate: "خريج",
    levelPlaceholderProfessional: "محترف",
    motivationField: "لماذا هذا الكورس؟ (اختياري)",
    motivationPlaceholder: "ما اللي تتطلع تبنيه أو تتعلمه",
    submitRegistration: "ابدأ الكورس",
